...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Cláudio Estevam
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">Programador full stack com foco em inteligência artificial. Experiência em desenvolvimento web e criação de modelos de IA.</p>
